        ...
        fun parseRTMEvent(text: String): RTMEvent {
            try {
                ...
                return when (RTMessageType.valueOf(type)) {
                    ...
                    RTMessageType.AcceptRaiseHand -> gson.fromJson(
                        jsonObject,
                        AcceptRaiseHand::class.java
                    )
                    RTMessageType.CancelHandRaising -> gson.fromJson(
                        jsonObject,
                        CancelHandRaising::class.java
                    )
                    ...
                    RTMessageType.RoomStatus -> gson.fromJson(
                        jsonObject,
                        RoomStatusRemote::class.java
                    )
                    RTMessageType.RequestChannelStatus -> gson.fromJson(
                        jsonObject,
                        RequestChannelStatus::class.java
                    )
                    RTMessageType.ChannelStatus -> gson.fromJson(
                        jsonObject,
